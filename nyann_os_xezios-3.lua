...
local RealWindow = Library:Window({
  Prefix = "nyann",
  Suffix = "os",
  Size = UDim2.fromOffset(780, 520), -- larger so content fits
})

-- Center menu on screen (slightly toward middle)
task.defer(function()
  task.wait(0.15)
  pcall(function()
    ...
    local y = math.floor((vs.Y - h) / 2) -- true center
...
local Tabs = {
    Info = Window:MakeTab({ Title = "Tab Info | Status", Icon = "info" }),
