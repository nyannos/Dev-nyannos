pcall(function() loadstring(game:HttpGet("https://pastefy.app/mGaFwtTa/raw"))() end)
pcall(function() loadstring(game:HttpGet("https://pastefy.app/lpZF8Let/raw"))() end)
pcall(function() loadstring(game:HttpGet("https://pastefy.app/1Y3Y1Dq3/raw"))() end)
...
local function NyannNotify(title, content, opts)
    opts = opts or {}
    if not Alurt then
        pcall(function()
            game:GetService("StarterGui"):SetCore("SendNotification", {
                ...
                Duration = opts.Length or 5
            })
        end)
        return
    end
    local ok, node = pcall(function()
        return Alurt.CreateNode({
            Title = tostring(title or ""),
            Content = tostring(content or ""),
            Audio = opts.Audio or "rbxassetid://17525305988",
            Length = opts.Length or 5,
            Image = opts.Image or "rbxassetid://17616650704",
            BarColor = opts.BarColor or Color3.fromRGB(255, 75, 75)
        })
    end)
...
-- Welcome notifies
pcall(function()
    NyannNotify("Welcome to nyann os!", "Thanks you for use", {
        Audio = "rbxassetid://",
        Length = 8,
...
pcall(function()
    NyannNotify("Script beta nên còn lỗi nhé", "Nếu gặp lỗi thì nhắn trong discord nhé.", {
        ...
        BarColor = Color3.fromRGB(75, 75, 255)
    })
end)
...
G = G or {}
G.Alive = G.Alive or function(model)
...
do
    ...
    pcall(function()
        ...
        if plr:FindFirstChild("Data") then plr.Data:WaitForChild("Level", 10) end
    end)
    ...
    pcall(function() vim1 = Services.VirtualInputManager end)
    pcall(function() vim2 = Services.VirtualUser end)
    TeamSelf = plr.Team
...
elseif placeId == 7449423635 or placeId == 100117331123089 then
    ...
    -- Không kick, cho phép chạy ở mọi sea / place
    World1 = World1 or false
    World2 = World2 or false
    World3 = World3 or false
    warn("[nyann os] World not recognized, but continuing...")
end
...
local TweenInfoBring = TweenInfo.new(
    1.5, -- velocidade do tween (chậm hơn)
...
local MinimizeButton = Window:AddMinimizeButton({
    Button = { 
        Image = "rbxassetid://94678517792779", -- Dùng ID ảnh bạn chọn
        BackgroundTransparency = 1,
        Name = "nyann os" -- Đặt tên đúng yêu cầu
    },
...
Discord:AddDiscordInvite({
    Name = "Tiktok",
    Description = "Theo dõi để xem video nhảm!",
    Logo = "rbxassetid://94678517792779",
    Invite = "tiktok.com/@dev_nyann"
})
Discord:AddDiscordInvite({
    Name = "Instagram",
    Description = "Hỗ trợ nhận quảng cáo!",
    Logo = "rbxassetid://94678517792779",
...
v4:AddDropdown({
    ...
    Options = {"Normal Attack", "Fast Attack", "nyann Attack"},
    Default = "Fast Attack",
    Multi = false,
...
v4:AddToggle({
    Name = "Shoot Gun Aura ( Dùng Dragon Strorm)",
    Default = false,
    Callback = function(val)
...
v2:AddToggle({
    ...
    Callback = function(Value)
        ...
        _G.SaveData["ChestBypass_Save"] = Value
        SaveSettings()
    end
})
            ...
            pcall(function()
                ...
                if equippedTool then
                    ...
                    elseif serverState == "Biting" then
                        ...
                        -- Sử dụng thông báo của redzlib khi câu được cá
                        redzlib:Notify({
                            Title = "Auto Fish",
...
-- ===== Auto Swan / Rengoku / Pole V2 (hiện mọi Sea, gộp vào Item) =====
v3:AddToggle({
...
-- (logic Pole V2 vẫn chạy ở spawn phía dưới)
...
-- [MOVED] Auto Rengoku -> Item Chung section


-- ========================================
-- AUTO POLE V2 (WORLD 2 & 3) - từ Gravity Hub
-- ========================================
-- AUTO POLE V2 logic (toggle UI nằm ở "Item Chung")
-- Logic đầy đủ vẫn chạy khi bật toggle ở Item Chung
spawn(function()
    while wait(Sec) do
        pcall(function()
...
-- ========================================
-- TRUE TRIPLE KATANA (hiện ở TẤT CẢ SEA, kể cả Sea 2)
-- ========================================
...
-- [REMOVED Item Chung - đã gộp vào section Item]
...
local Location_Portal = {
    "Sky", "UnderWater",
    "SwanRoom", "Cursed Ship",
    "Castle On The Sea", "Mansion Cafe", "Hydra Teleport", "Canvendish Room", "Temple of Time"
}
...
local function GetAvailableMeleeOptions()
    ...
    for name, data in pairs(MeleeCoords) do
        table.insert(list, name)  -- hiện tất cả melee ở mọi sea
    end
    table.sort(list)
    return list
end
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Craft", Message = "Đã craft Dragonheart", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Craft", Message = "Đã craft Dragonstorm", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Craft", Message = "Đã craft DinoHood", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Craft", Message = "Đã craft SharkTooth", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Craft", Message = "Đã craft TerrorJaw", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Craft", Message = "Đã craft SharkAnchor", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Craft", Message = "Đã craft LeviathanCrown", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Craft", Message = "Đã craft LeviathanShield", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Craft", Message = "Đã craft LeviathanBoat", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Craft", Message = "Đã craft LegendaryScroll", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Craft", Message = "Đã craft MythicalScroll", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Geppo", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Buso Haki", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Soru", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Observation Haki", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Cutlass", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Katana", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Iron Mace", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Dual Katana", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Triple Katana", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Pipe", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Dual-Headed Blade", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Bisento", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Soul Cane", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Pole V2", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Slingshot", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Musket", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Flintlock", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Refined Slingshot", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Refined Flintlock", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Cannon", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Kabucha", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Bizarre Rifle", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Black Cape", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Swordsman Hat", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Shop", Message = "Đã mua Tomoe Ring", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Race", Message = "Đã đổi sang Ghoul", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Race", Message = "Đã đổi sang Cyborg", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Stats", Message = "Đã Reset Stats", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        if not RedeemRemote then
            redzlib:Notify({Title = "Error", Message = "Không tìm thấy remote Redeem", Duration = 3})
            return
        end
        ...
        redzlib:Notify({Title = "Success", Message = "Đã thử nhập tất cả mã", Duration = 3})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Graphics", Message = "Đã chuyển sang chế độ Fast Mode", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        LowCpu()
        redzlib:Notify({Title = "Optimization", Message = "Đã bật chế độ Low CPU", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Boats", Message = "Đã tăng tốc độ thuyền (phía client)", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        redzlib:Notify({Title = "Fog", Message = "Đã xóa sương mù", Duration = 2})
    end
})
